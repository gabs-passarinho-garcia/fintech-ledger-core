    ...
    macroFn: {
        readonly isSignIn: (enable: boolean) => {
            readonly beforeHandle: ({ headers, scope, error }: {
                ...
                status: <const Code extends number | keyof import("elysia").StatusMap, const T = Code extends 200 | 201 | 202 | 204 | 400 | 401 | 403 | 404 | 405 | 409 | 422 | 429 | 500 | 503 | 504 | 406 | 100 | 101 | 102 | 103 | 203 | 205 | 206 | 207 | 208 | 300 | 301 | 302 | 303 | 304 | 307 | 308 | 402 | 407 | 408 | 410 | 411 | 412 | 413 | 414 | 415 | 416 | 417 | 418 | 420 | 421 | 423 | 424 | 425 | 426 | 428 | 431 | 451 | 501 | 502 | 505 | 506 | 507 | 508 | 510 | 511 ? {
