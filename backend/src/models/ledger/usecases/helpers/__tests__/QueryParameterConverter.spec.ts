...
describe('QueryParameterConverter', () => {
  describe('toDate', () => {
    it('should return Date object when value is already a Date', async () => {
    ...
    it('should return undefined when value is not a Date or string', async () => {
  ...
  describe('toNumber', () => {
    it('should return number when value is already a number', async () => {
    ...
    it('should return undefined when string is not a valid number', async () => {
    ...
    it('should return undefined when value is not a number or string', async () => {
  ...
  describe('normalizePagination', () => {
    it('should return default values when both parameters are undefined', async () => {
    ...
    it('should normalize page and limit from numbers', async () => {
    ...
    it('should normalize page and limit from strings', async () => {
    ...
    it('should use default page when page is undefined', async () => {
    ...
    it('should cap limit at 100 when limit is string', async () => {
    ...
    it('should handle invalid page values by using default', async () => {
    ...
    it('should handle invalid limit values by using default', async () => {
